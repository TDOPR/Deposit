 ...
 */
@FeignClient(url = "${tron.url}", name = "tron-node", configuration = {JacksonEncoder.class, JacksonDecoder.class})
public interface TronFullNodeFeign {
     ...
     */
    @Headers({"Content-Type: application/json","Accept: application/json"})
    @PostMapping("/wallet/getTransactionFromBlock")
    JSONObject getTransactionFromBlock (@RequestBody Map<String, Object> param);
    ...
    List<JSONObject> gettransactioninfobyblocknum (@RequestBody Map<String, Object> param);
