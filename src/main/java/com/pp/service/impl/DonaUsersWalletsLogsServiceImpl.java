...
import com.pp.mapper.DonaUsersWalletsLogsMapper;
...
//    }
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public Long insertDonaUsersIntegralWalletsLogs(Integer userId, BigDecimal amount, FlowingActionEnum flowingActionEnum, UsdLogTypeEnum usdLogTypeEnum) {
        //添加钱包流水记录
        DonaUsersWalletsLogs donaUsersWalletsLogs = DonaUsersWalletsLogs.builder()
                .userId(userId)
