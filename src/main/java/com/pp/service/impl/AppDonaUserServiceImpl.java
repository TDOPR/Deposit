...
import com.pp.constant.CarbonConfig;
import com.pp.enums.FlowingActionEnum;
import com.pp.enums.IntegralEnum;
import com.pp.enums.ReturnMessageEnum;
import com.pp.enums.VipLevelEnum;
import com.pp.mapper.AppDonaUsersMapper;
...
import com.pp.service.AppDonaUserService;
...
//            appUsers.setInviteId(inviteUserId);
            ...
            appDonaUsers.setPassword(AESUtil.encrypt(bindMailDTO.getPassword(), appDonaUsers.getSalt()));
...
//        Integer userId = JwtTokenUtil.getUserIdFromToken(ThreadLocalManager.getToken());
//
//        AppUsers appUsers = this.selectColumnsByUserId(userId, AppDonaUsers::getHeadImage);
